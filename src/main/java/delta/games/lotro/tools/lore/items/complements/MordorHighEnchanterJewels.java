...
public class MordorHighEnchanterJewels
{
  ...
  private void doMightYellowRing()
  {
    ...
    _injector.injectMinLevel(MIN_LEVEL,turca);
  }
  ...
  private void doMightVanguard()
  {
   // Barter Incomparable Jewels (Vanguard)
    ...
    // Bind on Acquire 1
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,vanguard);
    }
    // Bind on Acquire 2
    {
  ...
  private void doMightMordorBane()
  {
    ...
    // Bind to Account on Acquire
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,mordorBaneBAonA);
    }
    // Bind on Acquire 1
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,mordorBane);
    }
    // Bind on Acquire 2
    {
  ...
  private void doAgilityYellowRing()
  {
    ...
    _injector.injectMinLevel(MIN_LEVEL,linta);
  }
  ...
  private void doWillYellowRing()
  {
    ...
    _injector.injectMinLevel(MIN_LEVEL,iswa);
  }
