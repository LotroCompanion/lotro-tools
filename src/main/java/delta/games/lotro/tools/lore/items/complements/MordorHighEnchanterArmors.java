...
public class MordorHighEnchanterArmors
{
  ...
  private void doHeavyArmor()
  {
    // Barter Incomparable Armor (Vanguard)
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,vanguard1);
      ...
      _injector.injectMinLevel(MIN_LEVEL,vanguard2);
      ...
      _injector.injectMinLevel(MIN_LEVEL,vanguardBAonA);
    ...
    // Barter Incomparable Armor (Mordor's Bane)
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,bane1);
      ...
      _injector.injectMinLevel(MIN_LEVEL,bane2);
      ...
      _injector.injectMinLevel(MIN_LEVEL,baneBAonA);
    ...
    // Cloaks
    {
      ...
      _injector.injectMinLevel(MIN_LEVEL,cloaks1);
      ...
      _injector.injectMinLevel(MIN_LEVEL,cloaks2);
      ...
      _injector.injectMinLevel(MIN_LEVEL,cloaksBAonA);
