...
public class MainBuildUpdatePackage
{
  ...
  public static void main(String[] args)
  {
    ...
    File from=new File("D:/shared/damien/dev/lotrocompanion/releases/19.2/LotRO Companion/app");
    String packageName="patch19.2.33.01";
    Version newVersion=new Version(1921,"19.2.33.0.1");
