...
import delta.games.lotro.tools.extraction.maps.classification.CropClassification;
import delta.games.lotro.tools.extraction.maps.classification.MarkerClassifier;
import delta.games.lotro.tools.extraction.maps.classification.MonsterClassification;
import delta.games.lotro.tools.extraction.maps.classification.ResourceClassification;
import delta.games.lotro.tools.extraction.maps.markers.MarkerDuplicatesRemover;
import delta.games.lotro.tools.extraction.maps.markers.MarkersStore;
