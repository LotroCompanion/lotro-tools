package delta.games.lotro.tools.extraction.common.enums;
...
import delta.games.lotro.tools.extraction.utils.i18n.TranslationUtils;
...
public class MainDatEnumsLoader
{
  ...
  private void buildEquipmentSlotEnum()
  {
    ...
    String labelsSetName=ENUM_PREFIX+implClass.getSimpleName();
    I18nUtils i18n=new I18nUtils(labelsSetName,_facade.getGlobalStringsManager());
    handleCustomEntry(lotroEnum,i18n,0,enumName+".NONE","NONE");
    handleCustomEntry(lotroEnum,i18n,1,enumName+".HEAD","HEAD");
    handleCustomEntry(lotroEnum,i18n,2,enumName+".SHOULDER","SHOULDER");
    handleCustomEntry(lotroEnum,i18n,3,enumName+".BACK","BACK");
    handleCustomEntry(lotroEnum,i18n,4,enumName+".CHEST","CHEST");
    handleCustomEntry(lotroEnum,i18n,5,enumName+".HAND","HAND");
    handleCustomEntry(lotroEnum,i18n,6,enumName+".LEGS","LEGS");
    handleCustomEntry(lotroEnum,i18n,7,enumName+".FEET","FEET");
    handleCustomEntry(lotroEnum,i18n,8,enumName+".EAR","EAR");
    handleCustomEntry(lotroEnum,i18n,9,enumName+".LEFT_EAR","LEFT_EAR");
    handleCustomEntry(lotroEnum,i18n,10,enumName+".RIGHT_EAR","RIGHT_EAR");
    handleCustomEntry(lotroEnum,i18n,11,enumName+".NECK","NECK");
    handleCustomEntry(lotroEnum,i18n,12,enumName+".WRIST","WRIST");
    handleCustomEntry(lotroEnum,i18n,13,enumName+".LEFT_WRIST","LEFT_WRIST");
    handleCustomEntry(lotroEnum,i18n,14,enumName+".RIGHT_WRIST","RIGHT_WRIST");
    handleCustomEntry(lotroEnum,i18n,15,enumName+".FINGER","FINGER");
    handleCustomEntry(lotroEnum,i18n,16,enumName+".LEFT_FINGER","LEFT_FINGER");
    handleCustomEntry(lotroEnum,i18n,17,enumName+".RIGHT_FINGER","RIGHT_FINGER");
    handleCustomEntry(lotroEnum,i18n,18,enumName+".POCKET","POCKET");
    handleCustomEntry(lotroEnum,i18n,19,enumName+".MAIN_HAND","MAIN_HAND");
    handleCustomEntry(lotroEnum,i18n,20,enumName+".OFF_HAND","OFF_HAND");
    handleCustomEntry(lotroEnum,i18n,21,enumName+".EITHER_HAND","EITHER_HAND");
    handleCustomEntry(lotroEnum,i18n,22,enumName+".RANGED_ITEM","RANGED_ITEM");
    handleCustomEntry(lotroEnum,i18n,23,enumName+".TOOL","TOOL");
