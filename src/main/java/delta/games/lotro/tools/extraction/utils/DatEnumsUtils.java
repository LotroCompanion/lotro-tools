...
public class DatEnumsUtils
{
  ...
  public static EquipmentLocation getLocationFromAllowedSlots(int allowedSlots)
  {
    ...
    if (allowedSlots==-536870656) return EquipmentLocations.LEFT_WRIST;
    if (allowedSlots==-536870400) return EquipmentLocations.RIGHT_WRIST;
    if (allowedSlots==-536870144) return EquipmentLocations.WRIST;
    if (allowedSlots==-536869888) return EquipmentLocations.NECK;
    if (allowedSlots==-536868864) return EquipmentLocations.LEFT_FINGER;
    if (allowedSlots==-536866816) return EquipmentLocations.RIGHT_FINGER;
    if (allowedSlots==-536864768) return EquipmentLocations.FINGER;
    if (allowedSlots==-536862720) return EquipmentLocations.LEFT_EAR;
    if (allowedSlots==-536854528) return EquipmentLocations.RIGHT_EAR;
