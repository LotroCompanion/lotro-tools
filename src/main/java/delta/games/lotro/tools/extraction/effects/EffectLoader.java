...
public class EffectLoader
{
  ...
  private Effect buildEffect(int classDef)
  {
    ...
    else if (classDef==3842) return new KillProcEffect();
    return new Effect();
  }
  ...
  private void loadSpecifics(Effect effect, PropertiesSet effectProps)
  {
    ...
    {
      loadKillProcEffect((KillProcEffect)effect,effectProps);
    }
...
Effect_Aura_Type: 2 (Player)
  ...
  private void loadDispelEffect(DispelEffect effect, PropertiesSet props)
  {
    /*
...
Effect_RandomEffect_Array: 
  ...
  private void loadKillProcEffect(KillProcEffect effect, PropertiesSet effectProps)
  {
    loadPropertyModificationEffect(effect,effectProps);
    // 'caster' effects
