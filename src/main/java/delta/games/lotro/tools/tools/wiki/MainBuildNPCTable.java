...
public class MainBuildNPCTable
{
  ...
  private void handleNpc(int npcId)
  {
    ...
    {
      enName=DatStringUtils.getStringProperty(enProperties,"Name");
    ...
    {
      frName=DatStringUtils.getStringProperty(frProperties,"Name");
    ...
    {
      deName=DatStringUtils.getStringProperty(deProperties,"Name");
